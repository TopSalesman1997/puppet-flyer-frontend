...
/**
     ...
     * limitations under the License.
     */
class ne{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(function(e){const t=e.getComponent();return"VERSION"===t?.type}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null}).filter(e=>e).join(" ")}}const re="@firebase/app",ie="0.14.6",se=new F("@firebase/app"),oe="@firebase/app-compat",ae="@firebase/analytics-compat",ce="@firebase/analytics",ue="@firebase/app-check-compat",he="@firebase/app-check",le="@firebase/auth",de="@firebase/auth-compat",fe="@firebase/database",pe="@firebase/data-connect",me="@firebase/database-compat",ge="@firebase/functions",ye="@firebase/functions-compat",we="@firebase/installations",ve="@firebase/installations-compat",_e="@firebase/messaging",Ee="@firebase/messaging-compat",Ie="@firebase/performance",Te="@firebase/performance-compat",be="@firebase/remote-config",Se="@firebase/remote-config-compat",Ce="@firebase/storage",Ae="@firebase/storage-compat",ke="@firebase/firestore",Ne="@firebase/ai",Re="@firebase/firestore-compat",De="firebase",Pe="[DEFAULT]",Oe={[re]:"fire-core",[oe]:"fire-core-compat",[ce]:"fire-analytics",[ae]:"fire-analytics-compat",[he]:"fire-app-check",[ue]:"fire-app-check-compat",[le]:"fire-auth",[de]:"fire-auth-compat",[fe]:"fire-rtdb",[pe]:"fire-data-connect",[me]:"fire-rtdb-compat",[ge]:"fire-fn",[ye]:"fire-fn-compat",[we]:"fire-iid",[ve]:"fire-iid-compat",[_e]:"fire-fcm",[Ee]:"fire-fcm-compat",[Ie]:"fire-perf",[Te]:"fire-perf-compat",[be]:"fire-rc",[Se]:"fire-rc-compat",[Ce]:"fire-gcs",[Ae]:"fire-gcs-compat",[ke]:"fire-fst",[Re]:"fire-fst-compat",[Ne]:"fire-vertex","fire-js":"fire-js",[De]:"fire-js-all"},Le=new Map,xe=new Map,Me=new Map;function Ve(e,t){try{e.container.addComponent(t)}catch(n){se.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Ue(e){const t=e.name;if(Me.has(t))return se.debug(`There were multiple attempts to register component ${t}.`),!1;Me.set(t,e);for(const t of Le.values())Ve(t,e);for(const t of xe.values())Ve(t,e);return!0}function Fe(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function je(e){return null!=e&&void 0!==e.settings}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const $e="12.6.0";function ze(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r={name:Pe,automaticDataCollectionEnabled:!0,...t},i=r.name;if("string"!=typeof i||!i)throw Be.create("bad-app-name",{appName:String(i)});if(n||(n=u()),!n)throw Be.create("no-options");const s=Le.get(i);if(s){if(I(n,s.options)&&I(r,s.config))return s;throw Be.create("duplicate-app",{appName:i})}const o=new O(i);for(const e of Me.values())o.addComponent(e);const a=new qe(n,r,o);return Le.set(i,a),a}function He(e=Pe){const t=Le.get(e);if(!t&&e===Pe&&u())return ze();if(!t)throw Be.create("no-app",{appName:e});return t}function Ge(e,t,n){let r=Oe[e]??e;n&&(r+=`-${n}`);const i=r.match(/\s|\//),s=t.match(/\s|\//);if(i||s){const e=[`Unable to register library "${r}" with version "${t}":`];return i&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&s&&e.push("and"),s&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void se.warn(e.join(" "))}Ue(new R(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}
/**
     * @license
     * Copyright 2021 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */async function Dn(e,t){return kt(e,"POST","/v1/accounts:signInWithPassword",St(e,t))}async function Pn(e,t){return async function(e,t){return Ct(e,"POST","/v1/accounts:sendOobCode",St(e,t))}(e,t)}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Vn{constructor(){this.providerId=Vn.PROVIDER_ID}static credential(e,t){return On._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Mn.parseLink(t);return ft(n,"argument-error"),On._fromEmailAndCode(e,n.code,n.tenantId)}}Vn.PROVIDER_ID="password",Vn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Vn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const Ai=new F("@firebase/firestore");function ki(){return Ai.logLevel}function Ni(e,...t){if(Ai.logLevel<=L.DEBUG){const n=t.map(Pi);Ai.debug(`Firestore (${Ci}): ${e}`,...n)}}function Ri(e,...t){if(Ai.logLevel<=L.ERROR){const n=t.map(Pi);Ai.error(`Firestore (${Ci}): ${e}`,...n)}}function Di(e,...t){if(Ai.logLevel<=L.WARN){const n=t.map(Pi);Ai.warn(`Firestore (${Ci}): ${e}`,...n)}}function Pi(e){if("string"==typeof e)return e;try{
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Ps(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function Os(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function Ls(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class pa{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0!==n)for(const[t,r]of n)if(this.equalsFn(t,e))return r}has(e){return void 0!==this.get(e)}set(e,t){const n=this.mapKeyFn(e),r=this.inner[n];if(void 0===r)return this.inner[n]=[[e,t]],void this.innerSize++;for(let n=0;n<r.length;n++)if(this.equalsFn(r[n][0],e))return void(r[n]=[e,t]);r.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0===n)return!1;for(let r=0;r<n.length;r++)if(this.equalsFn(n[r][0],e))return 1===n.length?delete this.inner[t]:n.splice(r,1),this.innerSize--,!0;return!1}forEach(e){Os(this.inner,(t,n)=>{for(const[t,r]of n)e(t,r)})}isEmpty(){return Ls(this.inner)}size(){return this.innerSize}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class of{constructor(e,t){this._firestore=e,this._transaction=t,this._dataReader=Ed(e)}get(e){const t=sf(e,this._firestore),n=new Wd(this._firestore);return this._transaction.lookup([t._key]).then(e=>{if(!e||1!==e.length)return Oi(24041);const r=e[0];if(r.isFoundDocument())return new Ld(this._firestore,n,r.key,r,t.converter);if(r.isNoDocument())return new Ld(this._firestore,n,t._key,null,t.converter);throw Oi(18433,{doc:r})})}set(e,t,n){const r=sf(e,this._firestore),i=Kd(r.converter,t,n),s=Id(this._dataReader,"Transaction.set",r._key,i,null!==r.converter,n);return this._transaction.set(r._key,s),this}update(e,t,n,...r){const i=sf(e,this._firestore);let s;return s="string"==typeof(t=N(t))||t instanceof ld?function(e,t,n,r,i,s){const o=e.Cc(1,t,n),a=[Nd(t,r,n)],c=[i];if(s.length%2!=0)throw new Ui(Vi.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)a.push(Nd(t,s[e])),c.push(s[e+1]);const u=[],h=So.empty();for(let e=a.length-1;e>=0;--e)if(!Od(u,a[e])){const t=a[e];let n=c[e];n=N(n);const r=o.yc(t);if(n instanceof Td)u.push(t);else{const e=Sd(n,r);null!=e&&(u.push(t),h.set(t,e))}}const l=new js(u);return new yd(h,l,o.fieldTransforms)}(this._dataReader,"Transaction.update",i._key,t,n,r):function(e,t,n,r){const i=e.Cc(1,t,n);kd("Data must be an object, but it was:",i,r);const s=[],o=So.empty();Os(r,(e,r)=>{const a=Dd(t,e,n);r=N(r);const c=i.yc(a);if(r instanceof Td)s.push(a);else{const e=Sd(r,c);null!=e&&(s.push(a),o.set(a,e))}});const a=new js(s);return new yd(o,a,i.fieldTransforms)}(this._dataReader,"Transaction.update",i._key,t),this._transaction.update(i._key,s),this}delete(e){const t=sf(e,this._firestore);return this._transaction.delete(t._key),this}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
